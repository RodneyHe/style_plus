...
class BaseArgs(ABC):
    ...
    def add_args(self):
        ...
        self.parser.add_argument('--reals', action='store_true', help='Use real inputs', default=False)
        BaseArgs.add_bool_arg(self.parser, 'test_real_attr', default=False)
...
class TrainArgs(BaseArgs):
    ...
    def add_args(self):
        ...
        BaseArgs.add_bool_arg(self.parser, 'pixel_loss', default=True)
        BaseArgs.add_bool_arg(self.parser, 'S_D_loss', default=False)
